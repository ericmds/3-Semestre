...
a) Não poderá gaver nomes duplicados
b) Ao final do cadastro, a lista precisará ser ordenada;
c) O código deve permitir que o usuário digite um nome para pesquisa e o programa exclua esse nome da lista
